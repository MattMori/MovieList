...
Documentação do Projeto - Movie List
...
Para executar o projeto Movie List, você precisará do seguinte:
    ...
    NPM ou Yarn: O NPM é instalado automaticamente junto com o Node.js. Se preferir, você pode usar o Yarn como gerenciador de pacotes, que pode ser instalado seguindo as instruções em https://classic.yarnpkg.com/en/docs/install/.
...
Histórico de Versionamento:
    ...
    Versão 1.0.0 (Data: XX/XX/XXXX)
        ...
        Exibição de trailers do YouTube.
        Estilos básicos de UI.
    Versão 1.1.0 (Data: XX/XX/XXXX)
        Melhorias na interface de usuário.
        Correção de erros de linting e acessibilidade.
        Otimização de desempenho.
    Versão 1.2.0 (Data: XX/XX/XXXX)
        Adição de documentação.
        Melhorias na legibilidade do código.
        Atualização de dependências.
